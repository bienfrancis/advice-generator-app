...
const Card = () => {
   ...
   useEffect(() => {
    ...
    // if(isLoading){
    //     return(
    //         <div class="animate-spin inline-block w-10 h-10 border-[3px] border-current border-t-darkBlue text-neonGreen rounded-full" role="status" aria-label="loading">
        ...
        return (
            <div className='Card bg-darkGrayish max-w-lg mx-auto p-10 pb-16 rounded-xl relative'>
                ...
                <div className="card-button text-center absolute inset-x-0 bottom-0 mb-[-30px] flex items-end">
                    <button className='mx-auto bg-neonGreen p-4 shadow rounded-full hover:shadow-neonGreen hover:ring-2 hover:ring-neonGreen hover:outline-none' onClick={getRandom}>
